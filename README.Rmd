...
## Installation
You can install the released version of FactorAssumptions from [Github](https://github.com/storopoli/FactorAssumptions) with:
...
I encourage you to check the [vignette](doc/vignette.html) on how to use the package.
