...
## Installation
You can install the released version of FactorAssumptions from [CRAN](https://CRAN.R-project.org/package=FactorAssumptions) with:

```{r, eval=FALSE}
#install.packages("FactorAssumptions")
```

or install the development version from [Github](https://github.com/storopoli/FactorAssumptions) with:
